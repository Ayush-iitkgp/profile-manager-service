...
from src.models.schema.out_customer import OutDataLoginSchema, OutDataSetPasswordSchema
...
async def login(
    ...
    async with async_session() as db:
        return await CustomerService.set_customer_password(db, login_data)
